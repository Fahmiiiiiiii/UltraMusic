...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Fahmiiiiiiii/UltraMusic",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/Fahmiiiiiiii/UltraMusic")

...
from UltraMusic.utils.database import get_authuser_names, get_cmode
from UltraMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from UltraMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Ultra.stop_stream(message.chat.id)
    except:
        pass

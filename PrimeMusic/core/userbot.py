...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("UltraSupportChannel")
                await self.one.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("UltraSupportChannel")
                await self.two.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("UltraSupportChannel")
                await self.three.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("UltraSupportChannel")
                await self.four.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("UltraSupportChannel")
                await self.five.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(5)
            try:
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("UltraSupportChannel")
                await self.six.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(6)
            try:
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("UltraSupportChannel")
                await self.seven.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(7)
            try:
        ...
        if config.STRING8:
            ...
            try:
                await self.eight.join_chat("UltraSupportChannel")
                await self.eight.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(8)
            try:
        ...
        if config.STRING9:
            ...
            try:
                await self.nine.join_chat("UltraSupportChannel")
                await self.nine.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(9)
            try:
        ...
        if config.STRING10:
            ...
            try:
                await self.ten.join_chat("UltraSupportChannel")
                await self.ten.join_chat("UltraSupportGroup")
            except:
                pass
            assistants.append(9)
            try:
